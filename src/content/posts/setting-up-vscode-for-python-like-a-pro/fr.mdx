...
Les snippets sont de petits modèles de code que vous pouvez insérer rapidement. Voici comment en créer un pour une class Python avec le constructeur et les méthodes :
