...
Otherwise, if you want to import and combine multiple Excel/CSV files in a clean and optimized way, I invite you to read my article <Link href="https://macktireh.com/en/posts/import-multiple-excel-csv-files-power-bi-custom-power-query-function/" external>“Import Multiple Excel/CSV Files into Power BI with a Custom Power Query Function”</Link>.
