...
Sinon, si vous souhaitez importer et combiner plusieurs fichiers Excel/CSV de manière propre et optimisée, je vous invite à consulter mon article <Link href="https://macktireh.com/fr/posts/import-multiple-excel-csv-files-power-bi-custom-power-query-function/" external>“Importer Plusieurs Fichiers Excel/CSV dans Power BI avec une Fonction Power Query Personnalisée”</Link>.
