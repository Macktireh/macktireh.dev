...
Si vos fichiers sont des CSV, voici une version modifiée de la fonction qui prend en compte un séparateur personnalisé. Je vous invite à la tester et à l'adapter selon vos besoins :
